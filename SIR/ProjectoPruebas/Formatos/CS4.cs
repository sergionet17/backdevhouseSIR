...
{
    class CS4 : FormatoSUI
    {
        public override void Ejecutar()
        {
            var reporte = contextReporte.Obtener(new MODReporteFiltro { Nombre = "CS4", IdEmpresa = idEmpresa, IdServicio = idServicio });
        ...
        public override void Estructuras()
        {
            ...
            {
                Descripcion = "Reporte CS4 - DECRETO ## - YYYY",
                Nombre = "CS4",
                IdCategoria = idCategoriaSUI,
                EsReporte = true,
                Activo = true,
